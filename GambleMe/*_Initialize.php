...
$createCurrentBets = "CREATE TABLE IF NOT EXISTS currentBets(username varchar(30), winner varchar(30), home varchar(30), visitor varchar(30), amount float(9,2),date varchar(30));";
...
$currentBet1 = "INSERT INTO currentBets (username, winner, home, visitor,date, amount) VALUES('Bert', 'Vancouver', 'Calgary', 'Vancouver', '04/07/2016', 100.00);";

$currentBet2 = "INSERT INTO currentBets (username, winner, home, visitor,date ,amount) VALUES('Ross', 'Vancouver', 'Calgary','Vancouver', '04/07/2016', 100.00);";
